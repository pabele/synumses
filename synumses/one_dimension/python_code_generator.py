...
p_old  = Nv_00*exp(q*( (-Chi_00 - Eg_00) + Phi_p_old - Psi_old)/(kB*T))
n_old  = Nc_00*exp(q*(        +Chi_00    - Phi_n_old + Psi_old)/(kB*T))
...
def codeGenerator():
    ...
    global Chi_k, Chi_l, Eg_k, Eg_l, Nv_k, Nv_l, Nc_k, Nc_l

    global Psi_m1, Psi_00, Psi_p1, Phi_p_m1, Phi_p_00, Phi_p_p1, Phi_n_m1, Phi_n_00, Phi_n_p1


    global Chi_m1, Chi_00, Chi_p1, Eg_m1, Eg_00, Eg_p1, Nv_m1, Nv_00, Nv_p1, Nc_m1, Nc_00, Nc_p1
    ...
    #
    # As div_j_p and div_j_n have change,d functions must be updated
    #
    functions = [
        ["3*i+0",poisson, "poisson"],
        ["3*i+1",div_j_p, "div_j_p"],
