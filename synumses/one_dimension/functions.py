...
def calc_p_density():
    """
    Calculates the hole density.
    """
    p_density = parameters.Nv*np.exp(parameters.q*( parameters.u[1::3] - parameters.u[0::3] + parameters.Ev)/(parameters.kB*parameters.T))
...
def calc_n_density():
    ...
    """
    n_density = parameters.Nc*np.exp(parameters.q*( parameters.u[0::3] - parameters.u[2::3] - parameters.Ec)/(parameters.kB*parameters.T))
